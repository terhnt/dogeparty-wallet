function MessageFeed() {
  ...
  self.lastMessageSeqReceived = ko.observable(0); //message seq = the message feed sequence number generated by counterblock's unowallet module (mempool tx DO have indexes, and seqs DO NOT shift back during reorgs)
  ...
  self.parseMessage = function(seq, when, message) {
    ...
    //NOTE: we use the message sequence that the counterblock unowallet module generates, as it takes into account mempool transactions
    // (which come across the counterblock unowallet feed like any other message)
